<?php  return array (
  ...
  'prop_login.loginviaemail_desc' => 'Enable login via username or email address.',
  ...
  'prop_confirmregister.redirectUnsetDefaultParam_desc' => 'If true, default parameters will be removed from redirected urls.',
  ...
  'prop_confirmregister.errorpage_desc' => 'Optional. If set, will redirect user to a custom error page if they try to access the confirm register page with some validation error.',
